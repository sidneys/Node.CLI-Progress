...
module.exports = class Bar{
    ...
    render(){
        ...
        const fullMargin = Math.max(0, this.terminal.getWidth() - sWidth - 2);
        ...
        if (this.lastDrawnString != s){
            ...
            this.terminal.write(_os.EOL + _os.EOL);
            this.terminal.cursorTo(0, null);
            ...
            if (this.annotation !== null){
                // calculate left margin for aligning annotation with s(tring)
                const leftMargin = s.match(/^\s*/)[0].length;

                // move cursor below s(tring) and to and of left margin
                this.terminal.moveCursor(null, 1);
                this.terminal.cursorTo(leftMargin, null);
